...
from neuralterrena.users.views import UserRedirectView
from neuralterrena.users.views import UserUpdateView
from neuralterrena.users.views import user_detail_view
